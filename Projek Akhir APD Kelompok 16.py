    ...
    def logging_in(unameCounter, pwCounter, warning):
        ...
        if username == "staff":
            ...
            # jika password salah
                ...
                pwCounter += 1
                logging_in(unameCounter, pwCounter, "\033[1;31;40m Password salah! \033[0m      ")
        ...
        # jika username salah
            ...
            unameCounter  += 1
            logging_in(unameCounter, pwCounter, "\033[1;31;40m Username salah! \033[0m      ")
...
def GawatDarurat_reg():
    clear()
    function_title("Gawat Darurat", "Registrasi Pasien Baru")
    print("\n")
